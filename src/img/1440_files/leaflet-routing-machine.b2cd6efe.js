...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/lrm/leaflet-routing-machine.js":[function(require,module,exports) {
...
(function () {
  ...
  3: [function (_dereq_, module, exports) {
    ...
    module.exports = function (version) {
      ...
      return {
        capitalizeFirstLetter: function capitalizeFirstLetter(language, string) {
          return string.charAt(0).toLocaleUpperCase(language) + string.slice(1);
        },
        ordinalize: function ordinalize(language, number) {
          // Transform numbers to their translated ordinalized value
          if (!language) throw new Error("No language code provided");
          return instructions[language][version].constants.ordinalize[number.toString()] || "";
        },
        directionFromDegree: function directionFromDegree(language, degree) {
        ...
        laneConfig: function laneConfig(step) {
        ...
        getWayName: function getWayName(language, step, options) {
          var classes = options ? options.classes || [] : [];
          if (_typeof(step) !== "object") throw new Error("step must be an Object");
          if (!language) throw new Error("No language code provided");
         ...
         */
        compile: function compile(language, step, opts) {
          if (!language) throw new Error("No language code provided");
        ...
        grammarize: function grammarize(language, name, grammar) {
        ...
        tokenize: function tokenize(language, instruction, tokens, options) {
    ...
    (function (global) {
      (function () {
        ...
        module.exports = L.Class.extend({
          ...
          initialize: function initialize(elem, callback, context, options) {
          ...
          _createClickListener: function _createClickListener(r) {
          ...
          _resultSelected: function _resultSelected(r) {
            return L.bind(function () {
              this.close();
          ...
          _keyPressed: function _keyPressed(e) {
            var index;
          ...
          _complete: function _complete(completeFn, trySelect) {
      ...
      (function () {
        ...
        module.exports = Itinerary.extend({
          options: {
            ...
            routeLine: function routeLine(route, options) {
          ...
          spliceWaypoints: function spliceWaypoints() {
          ...
          _routeSelected: function _routeSelected(e) {
          ...
          _waypointsVisible: function _waypointsVisible() {
          ...
          _waypointsInViewport: function _waypointsInViewport() {
            var wps = this.getWaypoints(),
                mapBounds,
                i;
          ...
          _updateLines: function _updateLines(routes) {
          ...
          _hookEvents: function _hookEvents(l) {
            l.on("linetouched", function (e) {
              this._plan.dragNewWaypoint(e);
            }, this);
          },
          _hookAltEvents: function _hookAltEvents(l) {
            l.on("linetouched", function (e) {
          ...
          _onWaypointsChanged: function _onWaypointsChanged(e) {
            if (this.options.autoRoute) {
              this.route({});
            }
          ...
          _setupRouteDragging: function _setupRouteDragging() {
            var timer = 0,
                waypoints;
          ...
          _updateLineCallback: function _updateLineCallback(err, routes) {
            if (!err) {
              routes = routes.slice();
          ...
          _clearLines: function _clearLines() {
            if (this._line) {
      ...
      (function () {
        ...
        module.exports = L.Control.extend({
          options: {
            ...
            formatMessage: function formatMessage(error) {
              if (error.status < 0) {
          ...
          initialize: function initialize(routingControl, options) {
    ...
    (function (global) {
      (function () {
        ...
        module.exports = L.Class.extend({
          ...
          _round: function _round(d, sensitivity) {
          ...
          formatInstruction: function formatInstruction(instr, i) {
          ...
          getIconName: function getIconName(instr, i) {
            switch (instr.type) {
              case "Head":
                if (i === 0) {
                  return "depart";
          ...
          _getInstructionTemplate: function _getInstructionTemplate(instr, i) {
    ...
    (function (global) {
      (function () {
        ...
        module.exports = L.Class.extend({
          ...
          options: {
            createGeocoder: function createGeocoder(i, nWps, options) {
            ...
            geocoderPlaceholder: function geocoderPlaceholder(i, numberWaypoints, geocoderElement) {
              var l = new Localization(geocoderElement.options.language).localize("ui");
              return i === 0 ? l.startPlaceholder : i < numberWaypoints - 1 ? L.Util.template(l.viaPlaceholder, {
                viaNumber: i
              }) : l.endPlaceholder;
            },
            geocoderClass: function geocoderClass() {
              return "";
            },
            waypointNameFallback: function waypointNameFallback(latLng) {
          ...
          initialize: function initialize(wp, i, nWps, options) {
            L.setOptions(this, options);
  ...
  53: [function (_dereq_, module, exports) {
    (function (global) {
      ...
      L.routing = {
        ...
        itinerary: function itinerary(options) {
          return Itinerary(options);
        },
        line: function line(route, options) {
          return new Line(route, options);
        },
        plan: function plan(waypoints, options) {
          return new Plan(waypoints, options);
        },
        waypoint: function waypoint(latLng, name, options) {
          return new Waypoint(latLng, name, options);
        },
        osrmv1: function osrmv1(options) {
          return new OSRMv1(options);
        },
        localization: function localization(options) {
          return new Localization(options);
        },
        formatter: function formatter(options) {
          return new Formatter(options);
        },
        geocoderElement: function geocoderElement(wp, i, nWps, plan) {
          return new L.Routing.GeocoderElement(wp, i, nWps, plan);
        },
        itineraryBuilder: function itineraryBuilder(options) {
          return new ItineraryBuilder(options);
        },
        mapbox: function mapbox(accessToken, options) {
          return new Mapbox(accessToken, options);
        },
        errorControl: function errorControl(routingControl, options) {
          return new ErrorControl(routingControl, options);
        },
        autocomplete: function autocomplete(elem, callback, context, options) {
          return new Autocomplete(elem, callback, context, options);
        }
      };
      module.exports = L.Routing = (_L$Routing = {
        Control: Control,
        Itinerary: Itinerary,
        Line: Line,
        OSRMv1: OSRMv1,
      ...
      }, _defineProperty(_L$Routing, "Formatter", Formatter), _defineProperty(_L$Routing, "ItineraryBuilder", ItineraryBuilder), _defineProperty(_L$Routing, "control", L.routing.control), _defineProperty(_L$Routing, "itinerary", L.routing.itinerary), _defineProperty(_L$Routing, "line", L.routing.line), _defineProperty(_L$Routing, "plan", L.routing.plan), _defineProperty(_L$Routing, "waypoint", L.routing.waypoint), _defineProperty(_L$Routing, "osrmv1", L.routing.osrmv1), _defineProperty(_L$Routing, "geocoderElement", L.routing.geocoderElement), _defineProperty(_L$Routing, "mapbox", L.routing.mapbox), _defineProperty(_L$Routing, "errorControl", L.routing.errorControl), _L$Routing);
    }).call(this, typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {});
  }, {
    "./autocomplete": 48,
    "./control": 49,
    ...
    (function (global) {
      (function () {
        ...
        module.exports = L.Class.extend({
          ...
          createStepsContainer: function createStepsContainer() {
            return L.DomUtil.create("tbody", "");
          },
          createStep: function createStep(text, distance, icon, steps) {
    ...
    (function (global) {
      (function () {
        ...
        module.exports = L.Control.extend({
          ...
          onRemove: function onRemove() {},
          createAlternativesContainer: function createAlternativesContainer() {
            return L.DomUtil.create("div", "leaflet-routing-alternatives-container");
          },
          setAlternatives: function setAlternatives(routes) {
            var i, alt, altDiv;
          ...
          _createAlternative: function _createAlternative(alt, i) {
          ...
          _clearAlts: function _clearAlts() {
          ...
          _createItineraryContainer: function _createItineraryContainer(r) {
          ...
          _addRowListeners: function _addRowListeners(row, coordinate) {
          ...
          _onAltClicked: function _onAltClicked(e) {
          ...
          _selectAlt: function _selectAlt(e) {
          ...
          _selectRoute: function _selectRoute(routes) {
            if (this._marker) {
              this._map.removeLayer(this._marker);
    ...
    (function (global) {
      (function () {
        ...
        module.exports = L.LayerGroup.extend({
          ...
          initialize: function initialize(route, options) {
            L.setOptions(this, options);
          ...
          _findWaypointIndices: function _findWaypointIndices() {
          ...
          _findClosestRoutePoint: function _findClosestRoutePoint(latlng) {
          ...
          _extendToWaypoints: function _extendToWaypoints() {
            var wps = this._route.inputWaypoints,
          ...
          _addSegment: function _addSegment(coords, styles, mouselistener) {
            var i, pl;
          ...
          _findNearestWpBefore: function _findNearestWpBefore(i) {
          ...
          _onLineTouched: function _onLineTouched(e) {
          ...
          _getWaypointIndices: function _getWaypointIndices() {
            if (!this._wpIndices) {
    ...
    */
    (function () {
      ...
      var spanish = {
        ...
        formatOrder: function formatOrder(n) {
          return n + "º";
        },
        ui: {
      ...
      var Localization = L.Class.extend({
        initialize: function initialize(langs) {
        ...
        localize: function localize(keys) {
          var dict, key, value;
    ...
    (function (global) {
      (function () {
        ...
        module.exports = L.Class.extend({
          ...
          requiresMoreDetail: function requiresMoreDetail(route, zoom, bounds) {
          ...
          _convertRoute: function _convertRoute(responseRoute) {
            var result = {
              name: "",
              coordinates: [],
              instructions: [],
          ...
          _bearingToDirection: function _bearingToDirection(bearing) {
            var oct = Math.round(bearing / 45) % 8;
            return ["N", "NE", "E", "SE", "S", "SW", "W", "NW"][oct];
          },
          _maneuverToInstructionType: function _maneuverToInstructionType(maneuver, lastLeg) {
          ...
          _maneuverToModifier: function _maneuverToModifier(maneuver) {
          ...
          _camelCase: function _camelCase(s) {
            var words = s.split(" "),
                result = "";
          ...
          _leftOrRight: function _leftOrRight(d) {
            return d.indexOf("left") >= 0 ? "Left" : "Right";
          },
          _decodePolyline: function _decodePolyline(routeGeometry) {
          ...
          _locationKey: function _locationKey(location) {
            return location.lat + "," + location.lng;
          },
          _saveHintData: function _saveHintData(actualWaypoints, waypoints) {
            var loc;
            this._hints = {
              locations: {}
            };
      ...
      (function () {
        ...
        module.exports = (L.Layer || L.Class).extend({
          ...
          options: {
            ...
            addButtonClassName: "",
            language: "en",
            createGeocoderElement: function createGeocoderElement(wp, i, nWps, plan) {
          ...
          initialize: function initialize(waypoints, options) {
            L.Util.setOptions(this, options);
            this._waypoints = [];
          ...
          createGeocoders: function createGeocoders() {
          ...
          _createGeocoder: function _createGeocoder(i) {
          ...
          _updateGeocoders: function _updateGeocoders() {
            var elems = [],
                i,
                geocoderElem;
          ...
          _hookWaypointEvents: function _hookWaypointEvents(m, i, trackMouseMove) {
            var eventLatLng = function eventLatLng(e) {
          ...
          dragNewWaypoint: function dragNewWaypoint(e) {
          ...
          _dragNewWaypoint: function _dragNewWaypoint(newWpIndex, initialLatLng) {
          ...
          _focusGeocoder: function _focusGeocoder(i) {
    ...
    (function (global) {
      (function () {
        ...
        module.exports = L.Class.extend({
          ...
          initialize: function initialize(latLng, name, options) {
            L.Util.setOptions(this, options);
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","src/lrm/leaflet-routing-machine.js"], null)
//# sourceMappingURL=/leaflet-routing-machine.b2cd6efe.js.map